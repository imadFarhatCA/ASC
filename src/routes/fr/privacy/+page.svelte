<svelte:head>
	<title>Politique de confidentialité | Art Specialized Construction</title>
</svelte:head>

<section data-bs-version="5.1" class="article02 identitym5 cid-privacy" id="privacy-page">
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12 col-lg-10">
                <div class="content-wrapper">
                    <p class="mbr-label mbr-fonts-style display-4">Légal</p>
                    <div class="title-wrapper">
                        <h2 class="mbr-section-title mbr-fonts-style display-2">Politique de confidentialité</h2>
                    </div>
                    <div class="text-wrapper">
                        <p class="mbr-text mbr-fonts-style display-7">
                            ...
                            • Le contenu de votre message<br><br>
                            ...
                            <strong>4. Conservation des données</strong><br>
                            Nous conservons les soumissions du formulaire de contact uniquement aussi longtemps que nécessaire pour répondre à votre demande et à des fins de tenue de dossiers raisonnables. Vous pouvez demander la suppression de vos données à tout moment en nous contactant directement.<br><br>

                            <strong>5. Sécurité des données</strong><br>
                            Nous prenons des précautions raisonnables pour protéger vos informations personnelles. Cependant, aucune méthode de transmission sur Internet n'est sécurisée à 100 %, et nous ne pouvons garantir une sécurité absolue.<br><br>

                            <strong>6. Liens vers des tiers</strong><br>
                            Notre site web peut contenir des liens vers des réseaux sociaux et d'autres sites externes. Nous ne sommes pas responsables des pratiques de confidentialité de ces sites et vous encourageons à consulter leurs politiques de confidentialité respectives.<br><br>
                            ...
                            Nous pouvons mettre à jour cette politique de confidentialité de temps à autre. Les modifications seront reflétées sur cette page avec une date de mise à jour.<br><br>

                            <strong>9. Contact</strong><br>
                            Pour toute question ou demande relative à la confidentialité, veuillez contacter :<br>
                            Art Specialized Construction Inc.<br>
                            92-5889 av. Centennial, Côte-Saint-Luc, Québec H4W 1T2, Canada<br>
                            Courriel : info@artspecialized.com<br>
                            Téléphone : +1 (514) 416 7330
                        </p>
                    </div>
                </div>
            </div>
